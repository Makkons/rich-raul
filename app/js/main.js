...
/* harmony import */ var _components_headerNav_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/headerNav.js */ "./src/js/components/headerNav.js");
...
/* harmony import */ var _components_inputNested_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/inputNested.js */ "./src/js/components/inputNested.js");
...
/* harmony import */ var _components_citySearch_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/citySearch.js */ "./src/js/components/citySearch.js");
/* harmony import */ var _components_tags_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/tags.js */ "./src/js/components/tags.js");
/* harmony import */ var _components_inputValidator_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/inputValidator.js */ "./src/js/components/inputValidator.js");
...
if (productButtonAdd) {
  ...
  function renderProduct() {
    ...
    return {
      ...
      image: wrapper.querySelector(".swiper-details__image").getAttribute('src').trim(),
  ...
  function renderModal() {
    ...
    itemHTML += `
            ...
            <div class="product-modal__row">
              <a href="/cart.html" class="product-modal__button button button--big button--grey">
...
initInterestSwiper();
window.addEventListener('resize', () => {
  if (!document.querySelector('.interest__swiper')) return;
    ...
    click: function () {
      ...
      if (window.innerWidth >= 961) {
        ...
        if (container.classList.contains('swiper--zoom')) {
          ...
          (0,_functions_disable_scroll_js__WEBPACK_IMPORTED_MODULE_2__.disableScroll)();
          clickedSlide.scrollIntoView({
            behavior: 'auto',
            block: 'start'
          });
        } else {
...
const productListSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.product__swiper-list', {
  slidesPerView: 3,
  spaceBetween: 10,
  loop: true,
  navigation: {
    nextEl: '.swiper-button-next-blur',
    prevEl: '.swiper-button-prev-blur'
  },
  thumbs: {
